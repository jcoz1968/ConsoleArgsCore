    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            app.ExtendedHelpText = "This is a sample console app to demostrate the usage of Microsoft.Extensions.CommandLineUtils."
                + Environment.NewLine + "Depending on your OS, you may need to execute the application as ConsoleArgsCore.exe or 'dotnet ConsoleArgsCore.dll'";
